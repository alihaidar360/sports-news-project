  ...
  return (
    ...
    >
      <section>
        ...
        <p className="mt-3">
          When you subscribe to the PITCH newsletter we collect your email address.
      ...
      <section>
        ...
        <p className="mt-3">
          PITCH uses cookies and similar technologies to remember your preferences
      ...
      <section>
        ...
        <p className="mt-3">
          Some features on PITCH are powered by third parties — embedded posts from
      ...
      <section>
        ...
        <p className="mt-3">
          PITCH may show advertising served by third-party networks, including Google
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          personal data to third parties. Access to subscriber data inside PITCH is
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          <a href="mailto:privacy@pitch.example" className="text-accent underline-offset-4 hover:underline">
            privacy@pitch.example
          </a>{" "}
